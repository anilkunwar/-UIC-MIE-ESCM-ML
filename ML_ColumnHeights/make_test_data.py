...
test_images_folder_path='data/test/images/image_{}.npy'
test_labels_folder_path='data/test/labels/label_{}.npy'
...
for n in range(n_data):
    ...
    np.save(test_images_folder_path.format(n),image)
    
    np.save(test_labels_folder_path.format(n),label)
